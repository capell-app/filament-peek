...
use Capell\BlockLibrary\Enums\LivewireComponentsEnum;
...
class EditContentBlock extends EditRecord
{
    ...
    public function getTitle(): string|Htmlable
    {
        ...
        return new HtmlString(
            __(
                'capell-block-library::heading.edit_content_record',
    ...
    public function getSubheading(): string|Htmlable|null
    {
        ...
        return __('capell-block-library::heading.content_type', [
            'type' => $type->name,
        ]);
    }
