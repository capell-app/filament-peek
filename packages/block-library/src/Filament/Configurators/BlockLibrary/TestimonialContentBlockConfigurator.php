...
class TestimonialContentBlockConfigurator extends DefaultContentBlockConfigurator
{
            ...
            Group::make()
                ->schema([
                    TextInput::make('company')
                        ->label(__('capell-block-library::form.company')),
                    TextInput::make('position')
                        ->label(__('capell-block-library::form.position')),
                ]),
        ];
    }
