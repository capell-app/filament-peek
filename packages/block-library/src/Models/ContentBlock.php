...
namespace Capell\BlockLibrary\Models;

use Aimeos\Nestedset\Collection;
use Aimeos\Nestedset\NodeTrait;
use Aimeos\Nestedset\QueryBuilder;
use Bkwld\Cloner\Cloneable;
use Capell\BlockLibrary\Database\Factories\ContentBlockFactory;
use Capell\BlockLibrary\Models\Concerns\ComposhipsJsonRelationshipsTrait;
use Capell\BlockLibrary\Observers\ContentBlockObserver;
 ...
 * @property-read Collection<int, ContentBlock> $children
 ...
 * @property-read EloquentCollection|ContentBlock[] $related
...
class ContentBlock extends Model implements HasMedia, PageCacheable, Publishable, Typeable, Userstampable
{
    use Cloneable;
    ...
    protected static string $factory = ContentBlockFactory::class;
