@props([
    'columns' => $element->getMeta('columns', 2),
    'displayMode' => $element->getMeta('display_mode', 'grid'),
    'container',
    'containerKey',
    'containerWidth' => null,
    'loop',
        ...
        @if ($displayMode === 'carousel')
            ...
            >
                <div class="relative overflow-hidden rounded-2xl">
                    ...
                    >
                        @forelse ($assets as $elementAsset)
                            @php
                                $icon = $elementAsset->asset->getMeta('icon');
                                $role = $elementAsset->asset->getMeta('position');
                            @endphp
