...
@php
    $carouselId = sprintf('banner-carousel-%s-%s', $element->id ?? $element->key, $loop->index);
    $bannerItems = BuildAssetBannerItemsAction::run($element);
        ...
        >
            <div class="swiper-wrapper h-full w-full">
                @foreach ($bannerItems as $bannerItem)
                    ...
                    <div
                        @class([
                            'swiper-slide element-banner-item relative flex min-h-[20rem] w-full shrink-0 basis-full items-center justify-center',
