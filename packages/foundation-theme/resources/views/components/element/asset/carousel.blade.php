...
@props([
    ...
    'carouselAutoDelay' => (int) $element->getMeta('carousel_auto_delay', 5000),
    ...
    'carouselPagination' => (bool) $element->getMeta('carousel_pagination', false),
...
@php
    $carouselId = sprintf('carousel-%s-%s', $element->id ?? $element->key, $loop->index);
        ...
        >
            <div class="swiper-wrapper w-full">
                ...
                @php
                    ...
                    if (! $media) {
                        throw new RuntimeException('Image not found for ElementAsset: ' . $elementAsset->asset_type . ' ' . $elementAsset->id);
                    }
                ...
                {{-- format-ignore-end --}}
                    <div
                        @class([
                            'swiper-slide element-media-item group relative h-64 overflow-hidden text-center text-white',
                            'rounded-lg' => $rounded,
                        ])
                        tabindex="0"
                    >
