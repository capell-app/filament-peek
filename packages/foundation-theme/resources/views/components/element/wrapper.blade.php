...
@props([
    'backgroundAttachment' => $element->getMeta('background_attachment'),
    'backgroundColor' => $element->getMeta('background_color'),
    'backgroundImage' => ResolveLoadedElementBackgroundImageAction::run($element),
    'backgroundRepeat' => $element->getMeta('background_repeat', 'no-repeat'),
    'backgroundOverlay' => (bool) $element->getMeta('background_overlay'),
    'backgroundPosition' => $element->getMeta('background_position', 'center'),
    'backgroundSize' => $element->getMeta('background_size', 'cover'),
    'class' => '',
    'container',
    'containerKey',
    'containerClass' => '',
    ...
    'index',
    'margin' => Arr::wrap($element->getMeta('margin')),
    'padding' => Arr::wrap($element->getMeta('padding')),
    'tag' => 'section',
    'element',
])
@php
...
<{{ $tag }}
    id="{{ $containerKey . '-' . $element->key . "-{$index}" }}"
    {{
        $attributes->class([
            '@container element element-' . $element->key,
            $class => $class !== 'element-' . $element->key,
