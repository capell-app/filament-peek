...
@php
    ...
    $heroAssetSource = (string) data_get($pageMeta, 'hero_asset_source', 'block');
    $backgroundImage = $block->backgroundImage ?? $block->image;
    ...
    $heroItems = BuildHeroRailItemsRenderDataAction::run($block, $page, $heroAssetSource);
...
<x-capell-foundation-theme::block.wrapper
    class="capell-modern-hero-banner block-ap-hero-banner"
    :$container
    :$containerKey
    :$containerWidth
    :index="$loop->index"
