...
@props([
    'linkClass' => 'dropdown-item hover:text-primary focus:text-primary block w-full whitespace-nowrap bg-transparent px-4 py-3 text-left text-base text-sm font-medium leading-none',
    'name' => 'languages',
    'dropdownLabelClass' => '',
    'darkMode' => false,
    'align' => 'left',
