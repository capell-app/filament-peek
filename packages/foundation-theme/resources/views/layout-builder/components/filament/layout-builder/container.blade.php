...
>
    ...
    >
            ...
            <div class="flex items-center gap-3">
                ...
                >
                    <x-filament::link
                        ...
                        x-tooltip.raw="{{ __('capell-layout-builder::button.expand_all') }}"
                    >
                        {{ __('capell-layout-builder::button.expand') }}
                    </x-filament::link>
                    <x-filament::link
                        class="whitespace-nowrap"
                        color="gray"
                        ...
                        x-tooltip.raw="{{ __('capell-layout-builder::button.collapse_all') }}"
                    >
        ...
        <button
            ...
            title="{{ __('capell-layout-builder::message.drag_to_resize_container') }}"
