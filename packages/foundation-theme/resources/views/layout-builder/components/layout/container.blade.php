@php
    ...
    use Capell\Core\LayoutBuilder\Enums\ContainerAlignmentEnum;
    use Capell\Core\LayoutBuilder\Enums\ResponsiveVisibilityEnum;
    use Capell\Core\LayoutBuilder\Facades\CapellLayout;
