...
class TailwindAssetsGenerator
{
    ...
    {
        $config = config('capell-foundation-theme.tailwind', []);
        $origin = 'config:capell-foundation-theme.tailwind';
    ...
    {
        return config('capell-foundation-theme.tailwind.validate_sources', false);
    }
