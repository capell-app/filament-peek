...
This page is the consolidated implementation overview for the SEO Tools package. It is extracted from the package README, service providers, migrations, config files, routes, resources, models, actions, and the shared Capell ERD notes where available.
...
Gives editors and site operators practical checks before publishing and operational reports after launch.
...
- Run `vendor/bin/pest packages/seo-tools/tests` when package tests exist.
- Run the relevant host-app migration or package install flow in a disposable database.
- Open the listed admin or frontend surface and compare it with the screenshot plan.

## Package Manifest

- Composer name: `capell-app/seo-tools`
...
- Config: packages/seo-tools/config/capell-seo-tools.php
- Config: packages/seo-tools/config/exchanger.php
...
- Settings migration: 2026_04_18_000001_update_assistant_settings_add_ai_creator.php
- Settings migration: create_assistant_settings.php
...
Deployment should read [screenshots.json](screenshots.json), install the package with demo data, resolve each admin surface or frontend URL, and write images to `public/docs/screenshots/packages/seo-tools`.
