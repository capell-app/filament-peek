...
This focused guide extends [Overview](overview.md) for the SEO Tools package.

## Purpose

SEO Tools can warn or block publishing when page metadata, robots settings, canonical URLs, schema, internal links, social images, redirects, or Search Console checks do not meet the configured mode.
