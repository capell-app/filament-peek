...
@use(Capell\Admin\Livewire\LayoutBuilder;use Capell\Core\Models;use Capell\Admin\Facades\CapellAdmin;use Filament\Actions\Action;use Filament\Support\Enums\ActionSize;use Filament\Support\Enums\IconPosition;use Filament\Support\Enums\FontWeight)
            ...
            <div @class(['py-3', 'lg:col-span-3' => $image])>
                ...
                >
                    ...
                    @svg($editWidgetAssetAction->getIcon(),
                        'group-hover/asset:text-primary-500 dark:group-hover/asset:text-primary-400 ml-1.5 inline h-5 w-5 text-gray-400 dark:text-gray-500',
