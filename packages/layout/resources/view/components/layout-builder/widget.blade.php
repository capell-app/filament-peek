...
>
                        ...
                        >
                            ...
                            <x-filament::dropdown.list>
                                ...
                                <x-filament::dropdown.list.item
                                    href="{{ CapellAdmin::getFilamentResource('widget')::getUrl('edit', ['record' => $this->getContainerWidget($containerKey, $widgetIndex)]) }}"
                            ...
                            @foreach ($assetTypes as $assetType)
                                <x-filament::dropdown.list>
                                    <x-filament::dropdown.header
                                        ...
                                        color="gray"
                                        :icon="CapellAdmin::getAssetIcon($assetType)"
                                    >
                                        {{ __('capell-admin::generic.'.$assetType) }}
                                    </x-filament::dropdown.header>
    ...
    @if ($assetTypes)
        <x-capell-admin::layout-builder.widget.assets
            :$containerKey
            :$hasPageAssets
            :$occurrence
            :$assets
