                    ...
                    <span class="text-gray-800 dark:text-gray-300">
                        {!!
                            trans_choice('capell-admin::message.layout_count_on_pages', $this->layout->pages_count, [
                                ...
                                'url' => CapellAdmin::getResourcePage()::getUrl('index', [
                            ...
                            >
                                ...
                                <x-filament::dropdown.list>
                                    ...
                                    <x-filament::dropdown.list.item
                                        href="{{ CapellAdmin::getFilamentResource('layout')::getUrl('edit', ['record' => $this->layout_id]) }}"
            ...
            @if ($containers)
                ...
                >
                    @foreach ($containers as $containerKey => $container)
                        <x-capell-admin::layout-builder.container
                            :$container
                            :$containerKey
