# Backup Import Export Workflow

This focused guide extends [Overview](overview.md) for the Backup package.

## Purpose

Backup separates export, package validation, dependency graph review, relation resolution, import execution, and restore reporting.
