...
final class GA4ReportsDataClient implements GA4ReportsDataClientInterface
{
    ...
    public function dailyMetrics(GA4ReportsWindowData $window): array
    {
        ...
        foreach ($rows as $row) {
            ...
            $metrics[] = new GA4ReportsDailyMetricData(
    ...
    public function pageMetrics(GA4ReportsWindowData $window): array
    {
        ...
        foreach ($rows as $row) {
            ...
            $metrics[] = new GA4ReportsPageMetricData(
                propertyId: $window->propertyId,
                metricDate: $metricDate instanceof CarbonImmutable ? $metricDate : $window->startsAt,
                pagePath: $pagePath,
     ...
     * @return list<array<string, mixed>>
     */
    private function paginatedPageReportRows(GA4ReportsWindowData $window): array
    {
        $rows = [];
        $offset = 0;
        $orderBys = [[
    ...
    private function credentials(): array
    {
        ...
        try {
            ...
            throw new GA4ReportsApiException('GA4 Reports credentials file contains invalid JSON.');
        }
