...
namespace Capell\Reports\Filament\Widgets;
...
use Capell\Reports\Data\Dashboard\PublishingTrendPointData;
...
final class PublishingTrendChartWidget extends ChartWidget implements CapellWidgetContract
{
    ...
    {
        return __('capell-reports::dashboard.widget_publishing_trend');
    }
    ...
    protected function getData(): array
    {
        ...
        return [
            'datasets' => [
                [
                    'label' => __('capell-reports::dashboard.chart_published_pages'),
                    'data' => array_map(
                ...
                [
                    'label' => __('capell-reports::dashboard.chart_scheduled_pages'),
                    'data' => array_map(
