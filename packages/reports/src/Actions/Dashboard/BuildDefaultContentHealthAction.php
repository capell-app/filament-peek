...
namespace Capell\Reports\Actions\Dashboard;
...
final class BuildDefaultContentHealthAction
{
    ...
    {
        $issues = [
            $this->makeIssue('scheduled_pages', __('capell-reports::dashboard.issue_scheduled_pages'), $this->basePageQuery()->pending()->count()),
            $this->makeIssue('expired_pages', __('capell-reports::dashboard.issue_expired_pages'), $this->basePageQuery()->expired()->count()),
            $this->makeIssue('pages_without_urls', __('capell-reports::dashboard.issue_pages_without_urls'), $this->pagesWithoutUrlsCount()),
            $this->makeIssue('stale_pages', __('capell-reports::dashboard.issue_stale_pages', ['days' => $staleDays]), $this->stalePagesCount($staleDays)),
        ];
