...
use Capell\ExtensionMarketplace\Tests\TestCase as ExtensionMarketplaceTestCase;
...
pest()->extend(ExtensionMarketplaceTestCase::class)->in('../packages/extension-marketplace/tests');
