...
use Capell\MediaAssistant\Tests\MediaAssistantTestCase;
...
pest()->extend(MediaAssistantTestCase::class)->group('media-assistant')->in('../packages/media-assistant/tests');
...
pest()->extend(PasswordSecurityTestCase::class)->group('password-security')->in('../packages/password-security/tests');
