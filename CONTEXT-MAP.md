...
| Commercial Integrations | `assistant`, `mcp`, `extension-marketplace`, `deployments`                                                                                                    | Assistant capabilities, MCP tools, marketplace registration/acquisition, and deployment publishing workflows.       |
