...
Usually no. It works automatically once installed. You will see its effect as a preview panel while editing.

## Where it shows up

In the admin editor, as a live preview alongside the form you are filling in.
